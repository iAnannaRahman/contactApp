...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(
                "create table myenemycontacts " +
                        "(enemyid integer primary key autoincrement, enemyname text,enemyphone text,enemyemail text, enemystreet text,enemyplace text)"
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS myenemycontacts");
